...
export declare const DEFAULT_CONFIG: LinuxdoConfig;
/**
 * 解析生效的站点列表：sites 为空时由顶层 baseUrl 派生单站点。
 */
export declare function resolveSites(config: LinuxdoConfig): SiteProfile[];
/**
 * 合并三层配置来源。inline 来自 cordis.yml 行内 config；
 * 环境变量覆盖默认值；inline 优先级最高。
 */
export declare function resolveConfig(inline: Partial<LinuxdoConfig> | undefined, env?: NodeJS.ProcessEnv): LinuxdoConfig;
