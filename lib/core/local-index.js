...
export function cjkBigram(text) {
    const out = [];
    let latinRun = '';
    let cjkRun = [];
    const flushLatin = () => {
...
export class LocalIndex {
    ...
    index(post) {
        ...
        const result = this.insertStmt.run(post.site, post.topicId, post.postId, post.postNumber, title, author, content, post.url, new Date().toISOString());
        this.db
