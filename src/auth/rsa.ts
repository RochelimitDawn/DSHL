...
export function decryptRsaPayload(privateKeyPem: string, base64Payload: string): string {
...
export function encryptRsaPayload(publicKeyPem: string, plaintext: string): string {
